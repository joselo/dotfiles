...
set -g status-right "#[fg=#202020,bg=#202020,nobold,nounderscore,noitalics]#[fg=#505050,bg=#202020] %d %b %R #[fg=#202020,bg=#202020,nobold,nounderscore,noitalics]#[fg=#505050,bg=#202020] #(~/.dotfiles/tmux/battstat.sh -c "AC:" -d "BAT:" {i} {p} {t})"
